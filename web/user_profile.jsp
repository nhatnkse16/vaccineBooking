                                        ...
                                        <div class="uni-search-appointment">
                                            <ul>
                                                ...
                                                <li class="uni-btn-appointment">
                                                    <a href="/Vaccine_testver1/UserManagerController">Hello</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        <ul>
                                                            ...
                                                            <li class="bg-info" style="margin: 12px; padding: 20px; background-color: #337ab7;">
                                                                <a href="/Vaccine_testver1/UserManagerController" style="color: white; background-color: #337ab7;">Booking history</a>
                                                            </li>
                                                        </ul>
                                                    </div>
